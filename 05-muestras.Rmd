...
leaflet(data = datos, width = 400 )%>%addCircles(lng = ~MUESTLONG, lat = ~MUESTLATI, popup = ~FINCANOMB, label = ~MUESTRAID1, radius = 10, fill = TRUE, fillColor = "blue", fillOpacity = 0.3, color = "red" )%>%addProviderTiles(providers$Esri.WorldImagery)
```
</center></div>
<br>
